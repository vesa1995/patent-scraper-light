...
// todo just fix async and that is it (search result size not working, also no problem for invalid app_num)
// http://localhost:5000/bulgaria/EP10748211
// http://localhost:5000/bulgaria/EP18000815
export const getBulgariaData = async (req, res) => {
